...
<body class="bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 min-h-screen antialiased">
    ...
    <header class="relative overflow-hidden">
        <div class="absolute inset-0 bg-gradient-to-br from-primary-500/5 via-transparent to-blue-500/5 dark:from-primary-900/20 dark:via-transparent dark:to-blue-900/10"></div>
        ...
        <div class="relative max-w-7xl mx-auto px-6 pt-24 pb-32 lg:pt-32 lg:pb-48 text-center">
            ...
            <h1 class="mt-10 text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-extrabold tracking-tight leading-none animate-[fadeInUp_1s] opacity-0 [animation-delay:400ms] [animation-fill-mode:forwards]">
                ...
                <span class="bg-gradient-to-r from-primary-600 via-blue-500 to-primary-500 bg-clip-text text-transparent">con inteligencia y control total</span>
            </h1>
            ...
            <div class="mt-12 flex flex-col sm:flex-row gap-5 justify-center animate-[fadeInUp_1s] opacity-0 [animation-delay:800ms] [animation-fill-mode:forwards]">
                <a href="{{ url('/admin') }}"
                   class="group relative inline-flex items-center gap-3 px-10 py-6 text-lg font-semibold text-white bg-gradient-to-r from-primary-600 to-blue-600 rounded-2xl shadow-2xl shadow-primary-500/30 hover:shadow-primary-600/50 hover:scale-[1.04] transition-all duration-400 overflow-hidden">
                    ...
                    <div class="absolute inset-0 bg-gradient-to-r from-primary-700 to-blue-700 scale-x-0 group-hover:scale-x-100 origin-left transition-transform duration-400"></div>
                </a>
    ...
    <section id="caracteristicas" class="py-24 lg:py-32">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
                ...
                <!-- Puedes seguir agregando más tarjetas con delays progresivos -->
            </div>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                ...
                <div class="hidden lg:block text-center animate-[fadeIn_1.4s] opacity-0 [animation-delay:500ms] [animation-fill-mode:forwards]">
                    <div class="inline-block w-40 h-40 rounded-full bg-gradient-to-br from-primary-500 to-blue-500 p-2 shadow-2xl animate-float">
                ...
                <div class="relative animate-[fadeInUp_1.2s] opacity-0 [animation-delay:700ms] [animation-fill-mode:forwards]">
                    <div class="absolute inset-0 bg-gradient-to-br from-emerald-600/5 to-cyan-600/5 dark:from-emerald-900/20 dark:to-cyan-900/20 rounded-3xl rotate-1"></div>
    ...
    <!-- CTA Final -->
    <section class="py-32 bg-gradient-to-br from-primary-600 via-blue-600 to-primary-700 text-white relative overflow-hidden">
        ...
        <div class="relative max-w-5xl mx-auto px-6 text-center">
            ...
            <a href="{{ url('/admin') }}"
               class="group relative inline-flex items-center gap-4 px-14 py-8 text-2xl font-bold bg-white text-primary-700 rounded-3xl shadow-2xl hover:shadow-4xl hover:scale-[1.05] transition-all duration-400 overflow-hidden">
                ...
                <div class="absolute inset-0 bg-gradient-to-r from-blue-100 to-primary-100 scale-x-0 group-hover:scale-x-100 origin-left transition-transform duration-500"></div>
            </a>
        </div>
    </section>
